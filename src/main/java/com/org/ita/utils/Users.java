...
public enum Users {
    ...
    KOVALYOV_VLADYSLAV(6, "Kovalyov Vladyslav", "vladkovalyov7",
    ...
    FEDYK_SVYATOSLAV(7, "Fedyk Svyatoslav", "coffezka",
    ...
    STANISLAV_KOVALOV(8, "Kovalov Stanislav", "stas-kov7",
    ...
    LYPSKYI_OLEKSANDR(9, "Lypskyi Oleksandr", "simpleUA",
