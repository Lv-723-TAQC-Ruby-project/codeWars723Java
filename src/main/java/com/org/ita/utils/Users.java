...
public enum Users {
    ...
    OMETIUKH_SOFIIA(1, "Ometiukh Sofiia", "Sofiia44",
    ...
    KMYTIUK_NATALYIA(2, "Kmytiuk Natalyia", "natayarov",
    ...
    KULYK_MARIIA(3, "Kulyk Mariia", "merykul",
    ...
    KHUDO_BOHDAN(4, "Khudo Bohdan", "bohdan-khudio",
    ...
    KOVALYOV_VLADYSLAV(5, "Kovalyov Vladyslav", "vladkovalyov7",
    ...
    STANISLAV_KOVALOV(7, "Kovalov Stanislav", "stas-kov7",
