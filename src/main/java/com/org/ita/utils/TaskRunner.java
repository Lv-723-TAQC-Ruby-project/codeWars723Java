...
public class TaskRunner {
    ...
    static final String resultSheetForRankingNBATask = "Los Angeles Clippers 104 Dallas Mavericks 88,New York Knicks 101 Atlanta Hawks 112,Indiana Pacers 103 Memphis Grizzlies 112,\n" +
    ...
    public void runNbaCup() {
        ...
        System.out.println(resultSheetForRankingNBATask);
        System.out.println("Please, enter team's name to see the scores: ");
        String toFind = reader.readString();
        String result = user.getSix().nbaCup(resultSheetForRankingNBATask,toFind);
